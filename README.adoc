...
- The [hotspot=28-34 file=0]`testReadiness()` test case compares the generated health report for the 
readiness checks with the actual status of the services. 
- The [hotspot=28-34 file=0]`testLiveness()` test case compares the generated health report for the 
