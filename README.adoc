...
A few more tests have been included to verify the basic functionality of the `system` and `inventory`
...
will run automatically as a part of the integration test suite.
