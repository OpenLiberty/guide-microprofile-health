...
:page-seo-title: Checking the health of microservices using MicroProfile Health
:page-seo-description: A tutorial and example on how to report the health status of microservices using MicroProfile Health readiness
and liveness checks.
