...
:page-tags: ['CDI', 'REST', 'HealthCheck', 'MicroProfile', '@Health', 'Config', 'ConfigProperty']
:page-permalink: /guides/{projectid}
:page-related-guides: ['microprofile-config', 'microprofile-metrics', 'cdi-intro']
...
RESTful services in an inventory manager application. This application and the services in it
...
After you start the application, you can access two microservices to test their availability. The
