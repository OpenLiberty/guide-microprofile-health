...
In this case, you are checking the heap memory usage. If more than 95% of the maximum memory
is being used, a status of `DOWN` is returned.
...
than 95% of the maximum memory is being used, a `DOWN` status is returned.
