...
:page-description: Learn how to use the MicroProfile Health feature to report the health of a RESTful application.
...
After you start the application, you can access the microservices to test their availability:
