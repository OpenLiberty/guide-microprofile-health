...
----
include::finish/src/main/java/io/openliberty/guides/system/SystemReadinessCheck.java[tags=SystemHealth]
----
...
[source, java, linenums, role='code_column']
----
include::finish/src/main/java/io/openliberty/guides/system/SystemLivenessCheck.java[tags=SystemHealth]
----
...
[source, java, linenums, role='code_column']
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryReadinessCheck.java[tags=InventoryHealth]
----
...
[source, java, linenums, role='code_column']
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryLivenessCheck.java[tags=InventoryHealth]
----
