...
overall health status of the application, as well as the aggregated data of the liveness, startup
...
The [hotspot=Liveness file=1]`@Startup` annotation indicates that this is a startup health check procedure.
...
The [hotspot=Liveness file=2]`@Liveness` annotation indicates that this is a liveness health check procedure.
...
This startup check verifies that the cpu memory usage is below 90% of the maximum memory.
...
the aggregated liveness,startup and readiness health reports on the two services:
```
curl -s http://localhost:9080/health | jq
```
{: codeblock}
...
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1.07 s - in it.io.openliberty.guides.system.SystemEndpointIT
[INFO] Running it.io.openliberty.guides.inventory.InventoryEndpointIT
[INFO] Tests run: 3, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.417 s - in it.io.openliberty.guides.inventory.InventoryEndpointIT
[INFO] Running it.io.openliberty.guides.health.HealthIT
[INFO] Tests run: 5, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 3.975 s - in it.io.openliberty.guides.health.HealthIT
[INFO] 
[INFO] Results:
[INFO] 
