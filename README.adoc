...
services. They can be found under the [hotspot=1-191 file=2]`src/test/java/it/io/openliberty/guides/inventory/InventoryEndpointTest.java`
and [hotspot=1-35 file=3]`src/test/java/it/io/openliberty/guides/system/SystemEndpointTest.java` files. 
...
[source, Java, linenums, role='code_column']
----
include::finish/src/test/java/it/io/openliberty/guides/system/SystemEndpointTest.java[!copyright]
----
