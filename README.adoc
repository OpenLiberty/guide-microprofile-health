...
The MicroProfile Health is a feature that provides an endpoint that you can get the health check results as a
...
* The `testIfServicesAreUp()` method sends a request to `/health` endpoint then
