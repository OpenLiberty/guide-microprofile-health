...
[hotspot=9]`mpHealth` feature has already been enabled for you in the [hotspot=1-15]`src/main/liberty/config/server.xml` 
file.
...
MicroProfile Config property defined in the [hotspot=1-4 file=1]`resources/CustomConfigSource.json` 
...
property to `true` in the [hotspot=1-4]`resources/CustomConfigSource.json` file. Because 
