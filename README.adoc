...
Otherwise, if the property is set to `true`, the service responds with an error message and a `503` response
code. Thus, If the service is down for maintenance, its health is `DOWN'.
...
the states of the two services.
