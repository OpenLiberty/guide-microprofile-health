...
property to `true` in the [hotspot]`resources/CustomConfigSource.json` file. 
...
* The [hotspot=testStartup file=0]`testStartup()` test case compares the generatede health report for the
