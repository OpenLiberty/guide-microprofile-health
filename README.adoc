...
[source, java, linenums, role='code_column tags=SystemReadinessCheck']
----
...
[hotspot= HealthCheckResponse]`HealthCheckResponse.named()` method is used to indicate what service the health 
...
[source, java, linenums, role='code_column tags=SystemLivenessCheck']
----
...
[source, java, linenums, role='code_column tags=InventoryReadinessCheck']
----
...
[source, java, linenums, role='code_column tags=InventoryLivenessCheck']
----
...
HealthTest.java
[source, java, linenums, role='code_column tags=HealthTest']
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTest.java[]
----
