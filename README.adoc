...
You will learn how to add a health check using Microprofile Health API to report the health of
...
You will implement health check to report the states of `InventoryResource` and `PropertiesResource`
RESTful services. Then you will write tests to validate the states of these services.

You can find the two RESTful services that already made up for you from here:
```
...
*  You can learn how to create the made up endpoints, `/system/properties` and `/inventory/hosts`,
from https://github.com/OpenLiberty/draft-guide-rest-cdi[REST-CDI] guide.
...
----
include::finish/src/main/java/io/openliberty/guides/system/PropertiesHealth.java[tags=healthAPI]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/system/PropertiesHealth.java[tags=requiredAnnotation]
----
...
Otherwise, set the state to be down. In addition, pass the service name to
`named()` method to know which service is being reported.

[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/system/PropertiesHealth.java[tags=healthResponse]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryHealth.java[tags=HealthCheckResponse]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryHealth.java[tags=isHealthy]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryHealth.java[tags=config]
----

Open `InventoryResource` in `/start/src/main/java/io/openliberty/guides/inventory/` and
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryResource.java[tags=listContents]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/inventory/InventoryResource.java[tags=JsonMessages]
----
...
[source, java, indent=0]
----
include::finish/src/main/java/io/openliberty/guides/common/JsonMessages.java[tags=serviceInMaintenance]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTestUtil.java[tags=connectToHealthEnpoint]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTestUtil.java[tags=getActualState]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTestUtil.java[tags=changeInventoryProperty]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTestUtil.java[tags=cleanUp]
----

Now, create the test class `HealthTest` in `/start/src/test/java/it/io/openliberty/guides/health` then add
the `setup()` method. Make it initialize the data needed for the two tests. Add `@Before` annotation it.

[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTest.java[tags=data]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTest.java[tags=testIfServicesStatesUp]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTest.java[tags=testIfInventoryTemporarilyDown]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTest.java[tags=checkServicesStates]
----
...
[source, java, indent=0]
----
include::finish/src/test/java/it/io/openliberty/guides/health/HealthTest.java[tags=After]
----
