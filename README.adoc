...
http://localhost:9080/health/started[http://localhost:9080/health/started^] URL to view the data from the startup health checks. Similarly, access the `/health/live`
