...
RESTful services in an inventory manager application. This application and the two services in it are provided for you in this guide. If you want to learn how to create a RESTful application, see 
