...
[role="code_command hotspot=15-50", subs="quotes"] 
---- 
...
[role="code_command hotspot=9-55", subs="quotes"] 
---- 
...
- The [hotspot=27-30]`testIfServicesAreUp()` test case compares the generated health report 
with the actual status of the services.
- The [hotspot=33-40]`testIfInventoryServiceIsDown()` test case puts the `inventory` service 
